local key = _G.Key
local check = "https://aigonhub.000webhostapp.com/checker.php?key=" .. key
...
CryoHubNWL.Parent = game.Players.LocalPlayer:WaitForChild("PlayerGui")
...
local function KCUBM_fake_script() -- Frame.Dragify 
...
coroutine.wrap(KCUBM_fake_script)()
local function TCDU_fake_script() -- CryoHubNWL.intro 
...
coroutine.wrap(TCDU_fake_script)()
local function LWXMI_fake_script() -- TextLabel.LocalScript 
...
coroutine.wrap(LWXMI_fake_script)()
